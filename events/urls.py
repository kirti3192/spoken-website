...
urlpatterns = patterns('',
    ...
    url(r'ajax-state-schools/$', 'events.views.ajax_state_schools', name='ajax_state_schools'),
    url(r'ajax-state-vocational/$', 'events.views.ajax_state_vocational', name='ajax_state_vocational'),
