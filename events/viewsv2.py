...
from events.forms import StudentBatchForm, TrainingRequestForm, \
    TrainingRequestEditForm, CourseMapForm, SingleTrainingForm ,AdminSingleTrainingForm
...
######################################################################################
class AdminSingletrainingCreateView(CreateView):
  form_class = AdminSingleTrainingForm
  template_name = ""
  success_url = "/software-training/single-training/approved/"
